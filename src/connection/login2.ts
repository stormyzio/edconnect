...
export async function login2(cookies: Cookie[], cookiesString: string, username: string, password: string) {
  ...
  let res = await fetch("https://api.ecoledirecte.com/v3/login.awp?v=4.90.1", requestOptions2);
  return res;
}
